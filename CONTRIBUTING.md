...
This document outlines the processes and practices recommended for contributing enhancements to `metacontroller-operator`.
...
To build `metacontroller-operator` run:
...
# Deploy the charm
juju deploy ./metacontroller-operator_ubuntu-20.04-amd64.charm    
```
